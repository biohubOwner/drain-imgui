...
namespace Offsets {
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t State = HumanoidState;
    ...
    namespace Lighting {
         ...
         inline constexpr uintptr_t ShadowColor = 0x140;
    ...
    namespace MeshPart {
         ...
         // Legacy compatibility alias
         inline constexpr uintptr_t MeshID_Offset = MeshId;
    }
    ...
    namespace VisualEngine {
         ...
         // Legacy compatibility aliases
         inline constexpr uintptr_t RenderView_Offset = RenderView;
         inline constexpr uintptr_t ToDataModel1 = FakeDataModel;
    ...
    namespace Workspace {
         ...
         // Legacy compatibility aliases
         inline constexpr uintptr_t Gravity = ReadOnlyGravity;
