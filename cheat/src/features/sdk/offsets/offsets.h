...
namespace Offsets {
    ...
    namespace FakeDataModel {
         inline constexpr uintptr_t Pointer = 0x7fa19a8;
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t State = 0x8d8;
         ...
         inline constexpr uintptr_t CameraOffset = 0x168;
    ...
    namespace Lighting {
         ...
         inline constexpr uintptr_t ShadowColor = 0x114;
         ...
         inline constexpr uintptr_t Bloom = 0x1f0;
         inline constexpr uintptr_t SunRays = 0x1f8;
         inline constexpr uintptr_t ColorCorrection = 0x200;
         inline constexpr uintptr_t DepthOfField = 0x208;
    }
    ...
    namespace MeshPart {
         inline constexpr uintptr_t MeshID_Offset = 0x2e8;
    ...
    namespace SpecialMesh {
         inline constexpr uintptr_t MeshID_Offset = 0x108;
         inline constexpr uintptr_t Scale = 0x164;
    }
    ...
    namespace VisualEngine {
         ...
         inline constexpr uintptr_t RenderView_Offset = 0x800;
